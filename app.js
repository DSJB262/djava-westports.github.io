...
const STAGES = [
  'Requested','Reported','Troubleshooting','Require Fix',
  'Development','Pending Mandays','Pending Mandays Approval','Pending Revised Mandays',
  'Testing','Plan for Release','Pending CR Approval',
  'Change Ticket Created','CAB Approval','Implementation','Resolved'
];

const STAGE_PCT = {
  'Requested':5,'Reported':10,'Troubleshooting':20,'Require Fix':30,
  'Development':45,'Pending Mandays':50,'Pending Mandays Approval':53,'Pending Revised Mandays':56,
  'Testing':65,'Plan for Release':72,'Pending CR Approval':78,
  'Change Ticket Created':82,'CAB Approval':88,'Implementation':95,'Resolved':100
};
...
function renderCharts(active) {
  ...
  const stageColors = [
    ...
    '#059669','#10B981','#34D399','#6EE7B7','#065F46','#9CA3AF'
  ];
